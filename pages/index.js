    ...
    return (
      <div className="min-h-screen min-w-screen bg-cover bg-center bg-gradient-to-b from-orange-400 to-yellow-200 z-0">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full px-6 py-12 sm:px-8 md:px-12 lg:px-16">
          <div className="w-full max-w-md rounded-3xl shadow-lg overflow-hidden relative">
            {/* Add a pseudo-element for the gradient border */}
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-pink-400 to-blue-400 p-1">
              <div className="bg-white h-full w-full rounded-[22px]"></div>
            </div>
            {/* Adjust the main content to fit within the gradient border */}
            <div className="relative rounded-3xl overflow-hidden">
              ...
              <div className="p-6 sm:p-8 md:p-10 lg:p-12 bg-gradient-to-t to-pink-100 from-blue-100 text-center">
                ...
                <p className="mt-4 mb-4 text-base text-pink-400 sm:text-md md:text-xl lg:text-xl font-medium">Nov 16, 2024 - 08:00 PM</p>
                <h2 className="text-2xl text-blue-400 sm:text-3xl md:text-4xl lg:text-4xl font-semibold">Event Location</h2>
                <p className="mt-4 mb-4 text-base text-pink-400 sm:text-md md:text-xl lg:text-xl font-medium">Senakunja, Dhaka Cantonment, Dhaka</p>
